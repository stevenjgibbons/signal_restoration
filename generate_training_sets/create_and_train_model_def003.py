#
# create_and_train_model_def003.py
...
# For this script, it is def003.
# If we change the model specifications, then we should make a new script
# with "_def003" replaced with something else.
# The output will be saved under "models/" + segdefname + "_def003"
